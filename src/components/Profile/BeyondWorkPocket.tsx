  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <button
          type="button"
          className="relative h-[240px] w-[260px] cursor-pointer text-left outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          onMouseEnter={() => setHovered(true)}
          onMouseLeave={() => setHovered(false)}
          aria-label="Open Beyond Work preview"
        >
          <div
      ...
      <DialogContent className="max-w-md rounded-2xl border-border bg-card">
        <DialogHeader>
          ...
          <DialogDescription className="text-muted-foreground">
            This Beyond Work section is being prepared. It will be available in a future update.
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
    </Dialog>
