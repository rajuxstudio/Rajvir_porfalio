...
import { Monitor, Shield, Smartphone, Search, Workflow, Layers, Map, CheckCircle2, Lock } from "lucide-react";
import ProjectDetailHero from "./shared/ProjectDetailHero";
...
export default function UtilityPlusDetail() {
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="px-6 sm:px-8 pb-8 flex flex-col gap-8 mt-6">
        {/* Segmented Switch */}
