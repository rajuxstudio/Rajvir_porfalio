...
export const projects: Project[] = [
  ...
  },
  {
    ...
    solution: "Built a marketplace-style platform with curated candidate profiles, smart matching, and a streamlined hiring pipeline that reduced time-to-hire by 40%.",
  },
  {
    id: 8,
    slug: "new-project",
    ...
    challenge: "Challenge details coming soon.",
